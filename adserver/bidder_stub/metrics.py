...
shape as feature_service/metrics.py; each service owns its own copy
rather than importing another service's module, per the "no
service-to-service imports" convention.
"""
